...
export const Radio: React.FC<IconProps> = ({ size = 24, className = "" }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const WifiIcon: React.FC<IconProps> = ({
  ...
  >
    ...
    <line x1="12" y1="20" x2="12" y2="20" /> {/* Puntito abajo */}
  </svg>
);

/** Ícono de señal Wifi tachado */
export const WifiOffIcon: React.FC<IconProps> = ({
  ...
  >
    ...
    <line x1="2" y1="2" x2="22" y2="22" /> {/* Línea diagonal tachando */}
  </svg>
);
...
export const HelpCircle: React.FC<IconProps> = ({
  ...
  >
    <circle cx="12" cy="12" r="10" />
    <path d="M9.09 9a3 3 0 1 1 5.82 1c0 1.5-3 2.5-3 2.5" />
